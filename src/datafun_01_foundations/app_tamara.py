...
TEACHER_NAME: Final[str] = "Miss Lane"


NUMBER_OF_STUDENTS: Final[int] = 78


HOURS_PER_WEEK_IN_USELESS_MEETINGS: Final[float] = 5.0


TEACHER_BESTIE_IS_OUT_SICK: Final[bool] = False
AVOIDED_ANNOYING_COWORKER: Final[bool] = True
...
STUDENT_FEEDBACK: Final[list[str]] = [
    "patience",
    "curiosity",
    "respectful",
    "kind",
...
def get_summary() -> str:
    ...
    Teacher Information:
        ...
        Number of students this semester: {NUMBER_OF_STUDENTS}
        Is having a fun day: {TEACHER_BESTIE_IS_OUT_SICK}
        Is happy today: {AVOIDED_ANNOYING_COWORKER}
        Positive traits: {STUDENT_FEEDBACK}
